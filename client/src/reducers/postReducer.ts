...
export function postReducer(state : postsState = initialState, action : Action){
    switch(action.type){
        ...
        case UPDATE_POST: {
            ...
            const index = state.posts.findIndex(obj => obj._id === post._id);
        ...
        case REQUEST_POST: {
            ...
            return{
                ...state,
                post: state.posts.filter(post => post._id == postId)[0]
            }
        }
        case ADDED_NEW_COMMENT:{
            ...
            return{
                ...state,
                posts: state.posts,
                post: state.posts.filter((post:Post) => post._id == postId)[0],
            }
        ...
        case DELETED_POST:{
            ...
            return{
                ...state,
                posts: state.posts.filter((post:Post) => post._id !== postId),
